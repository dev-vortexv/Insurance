...
import { getApi, postApi, EditApi, deleteApi } from '../../service/api';
...
const PackagesDetails = () => {
  ...
  const addPackagesData = async (data) => {
    const response = await postApi(userRole === 'admin' ? `packages/add` : `packages/add/?createdBy=${user_id}`, data);
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" mb={5} justifyContent={'space-between'}>
          <Typography variant="h4">Packages Lists</Typography>
