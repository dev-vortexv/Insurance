...
// ==============================|| DASHBOARD - TOTAL USER CARD ||============================== //

const TotalUsersCard = ({ isLoading, usersData }) => {
            ...
            <Grid container direction="column">
              ...
              <Grid item>
                <Grid container alignItems="center" justifyContent="center">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>{usersData.length}</Typography>
                  </Grid>
                  <Grid item>
                    <Avatar
                      sx={{
