...
const LeadEdit = (props) => {
  const { open, handleClose, editLead, leadData } = props;
  ...
  // -----------   initialValues
  const initialValues = {
    title: leadData?.title ? leadData?.title : '',
    ...
    gender: leadData?.gender ? leadData?.gender : '',
    phoneNumber: leadData?.phoneNumber ? leadData?.phoneNumber : '',
    emailAddress: leadData?.emailAddress ? leadData?.emailAddress : '',
    address: leadData?.address ? leadData?.address : '',
    leadSource: leadData?.leadScore ? leadData?.leadScore : '',
    leadStatus: leadData?.leadStatus ? leadData?.leadStatus : '',
    leadScore: leadData?.leadSource ? leadData?.leadSource : '',
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const leadsData = {
        ...
        leadStatus: values.leadStatus ? values.leadStatus : '',
        leadScore: values.leadScore ? values.leadScore : '',
        alternatePhoneNumber: values.alternatePhoneNumber ? values.alternatePhoneNumber : '',
        additionalEmailAddress: values.additionalEmailAddress ? values.additionalEmailAddress : '',
        instagramProfile: values.instagramProfile ? values.instagramProfile : '',
        twitterProfile: values.twitterProfile ? values.twitterProfile : '',
        typeOfInsurance: values.typeOfInsurance ? values.typeOfInsurance : '',
        desiredCoverageAmount: values.desiredCoverageAmount ? values.desiredCoverageAmount : '',
        specificPolicyFeatures: values.specificPolicyFeatures ? values.specificPolicyFeatures : '',
        QualificationStatus: values.QualificationStatus ? values.QualificationStatus : '',
        policyType: values.policyType ? values.policyType : '',
        ...
        coverageAmount: values.coverageAmount ? values.coverageAmount : '',
        termLength: values.termLength ? values.termLength : '',
        conversionReason: values.conversionReason ? values.conversionReason : '',
        conversionDateTime: values.conversionDateTime ? values.conversionDateTime : '',
        leadCategory: values.leadCategory ? values.leadCategory : '',
        leadPriority: values.leadPriority ? values.leadPriority : '',
        assigned_agent: values.assigned_agent ? values.assigned_agent : '',
        modifiedOn: new Date()
      };
      editLead(leadsData);
      handleClose();
