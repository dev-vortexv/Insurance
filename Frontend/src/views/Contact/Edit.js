...
const EditContact = (props) => {
  const { open, handleClose, editContact, editData } = props;
  ...
  const initialValues = {
    ...
    dateOfBirth: editData?.dateOfBirth ? editData?.dateOfBirth : '',
    gender: editData?.gender ? editData?.gender : '',
    phoneNumber: editData?.phoneNumber ? editData?.phoneNumber : '',
    emailAddress: editData?.emailAddress ? editData?.emailAddress : '',
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const ContactPayload = {
        ...
        preferredContactMethod: values.preferredContactMethod ? values.preferredContactMethod : '',
        referralSource: values.referralSource ? values.referralSource : '',
        referralContactName: values.referralContactName ? values.referralContactName : '',
        relationshipToReferrer: values.relationshipToReferrer ? values.relationshipToReferrer : '',
        preferencesForMarketingCommunications: values.preferencesForMarketingCommunications
          ? values.preferencesForMarketingCommunications
          : '',
        preferredLanguage: values.preferredLanguage ? values.preferredLanguage : '',
        modifiedOn: new Date()
      };
      editContact(ContactPayload);
      handleClose();
    }
  });
