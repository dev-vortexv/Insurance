...
const Policy = ({ toggleVisibilityPolicy, isVisiblePolicy, getAllContactDetails, rows }) => {
  ...
  return (
    <div>
      {/* Add Claim */}
      <AddPolicy open={openAdd} handleClose={handleCloseAdd} getAllContactDetails={getAllContactDetails} />
