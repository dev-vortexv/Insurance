          ...
          <Grid container display="flex" spacing={4}>
            <Grid item xs={12} sm={6}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.relationshipToTheInsured ? data?.relationshipToTheInsured : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                <Typography variant="body2" color={Palette.grey[600]} textTransform={'capitalize'}>
                  {data?.additionalInsuredPersonName ? data?.additionalInsuredPersonName : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1"> Relationship to the insured (if applicable) : </Typography>
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.additionalRelationshipToTheInsured ? data?.additionalRelationshipToTheInsured : '--'}
                </Typography>
              </Grid>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                <Typography variant="body2" color={Palette.grey[600]} textTransform={'capitalize'}>
                  {data?.underwriterName ? data?.underwriterName : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Email :</Typography>
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.underwriterEmail ? data?.underwriterEmail : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Phone :</Typography>
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.underwriterPhone ? data?.underwriterPhone : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Decisions Or Remark:</Typography>
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.underwriterDecisions ? data?.underwriterDecisions : '--'}
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Email :</Typography>
                <Typography variant="body2" color={Palette.primary.main} style={{ cursor: 'pointer' }}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="h4" py={2}>
                  Additional Insured contact information :-
                </Typography>
                <Typography variant="body1"> Phone Number :</Typography>
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.additionalPhoneNumber ? data?.additionalPhoneNumber : '--'}
                </Typography>
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Email :</Typography>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2} display={'flex'}>
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    variant="body2"
                    color={Palette.grey[600]}
                    onClick={() => (data?.additionalInstagramProfile ? handleInsta(data?.additionalInstagramProfile) : '--')}
                    style={{ cursor: 'pointer', textDecoration: 'none', color: Palette.primary.main }}
                  >
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    variant="body2"
                    color={Palette.grey[600]}
                    onClick={() => (data?.additionalTwitterProfile ? handleTwitter(data?.additionalTwitterProfile) : '--')}
                    style={{ cursor: 'pointer', textDecoration: 'none', color: Palette.primary.main }}
                  >
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.FrequencyOfPremiumPayments ? data?.FrequencyOfPremiumPayments : '--'}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
