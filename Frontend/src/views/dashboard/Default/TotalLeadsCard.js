...
// assets
import LeadIcon from 'assets/images/icons/lead.svg';
            ...
            <Grid container direction="column">
                ...
                <Grid container justifyContent="space-between">
                  ...
                  <Grid item display="flex" alignItems="center">
                    ...
                    >
                      ...
                      <MenuItem onClick={handleClose}>
                        <ArchiveTwoToneIcon sx={{ mr: 1.75 }} /> ArchiveFile
                      </MenuItem>
                    </Menu>
                  </Grid>
                </Grid>
              ...
              <Grid item>
                <Grid container alignItems="center" justifyContent="center" position="top">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>{leadData}</Typography>
                  </Grid>
                  <Grid item>
                    <Avatar
                      sx={{
