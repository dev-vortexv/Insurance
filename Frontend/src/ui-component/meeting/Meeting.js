...
const Meetings = ({ toggleVisibilityMeeting, isVisibleMeetings, addMeetingData, rows, id }) => {
  ...
  return (
    <div>
      {/* Add Meeting */}
      <Addmeetings open={openMeeting} handleClose={handleCloseMeeting} addMeetingData={addMeetingData} _id={id} />
