...
const Emails = ({ toggleVisibilityEmail, isVisibleEmail, rows, id, addEmailData }) => {
  ...
  return (
    <div>
      {/* Add email */}
      <Addemail open={openEmail} handleClose={handleCloseEmail} _id={id} addEmailData={addEmailData} />
