...
const Editcalls = (props) => {
  const { handleClose, open, editCallDetailsData, editCallData } = props;
  ...
  // -----------   initialValues
  const initialValues = {
    subject: editCallData.subject,
    status: editCallData.status,
    startDateTime: editCallData.startDateTime,
    duration: editCallData.duration,
    relatedTo: editCallData.relatedTo,
    note: editCallData.note,
    lead_id: editCallData?.lead_id?._id,
    contact_id: editCallData?.contact_id?._id,
    modifiedOn: ''
  };
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      editCallDetailsData(callPayload, editCallData._id);
      handleClose();
    }
  });
